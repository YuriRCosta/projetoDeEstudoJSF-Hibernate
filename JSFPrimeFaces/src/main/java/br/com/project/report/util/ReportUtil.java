...
public class ReportUtil implements Serializable{
	...
	public StreamedContent gerarRelatorio(List<?> listDataBeanCollectionReport, HashMap parametrosRelatorio,
			String nomeRelatorioJasper, String nomeRelatorioDeSaida, int tipoRelatorio) throws Exception {
		...
		nomeRelatorioDeSaida += UNDERLINE + DateUtils.getDateAtualReportName();
		
		// Caminho relatorio exportado
		caminhoArquivoRelatorio = caminhoRelatorio + SEPARATOR + nomeRelatorioDeSaida + PONTO + extensaoArquivoExportado;
		...
		arquivoRetorno = new DefaultStreamedContent(conteudoRelatorio, "application/"+extensaoArquivoExportado,nomeRelatorioDeSaida + PONTO + extensaoArquivoExportado);
