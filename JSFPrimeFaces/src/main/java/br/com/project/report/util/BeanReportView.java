...
public abstract class BeanReportView extends BeanViewAbstract {
	...
	public StreamedContent getArquivoReport() throws Exception {
		return getReportUtil().gerarRelatorio(getListDataBeanCollectionReport(), getParametrosRelatorio(), getNomeRelatorioJasper(), getNomeRelatorioJasper(), getTipoRelatorio());
	}
