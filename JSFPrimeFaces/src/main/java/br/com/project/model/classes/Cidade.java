...
public class Cidade implements Serializable{
	...
	@IdentificaCampoPesquisa(descricaoCampo = "Codigo", campoConsulta = "cid_codigo", principal = 1)
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "cidade_seq")
	private Long cid_codigo;
	
	@IdentificaCampoPesquisa(descricaoCampo = "Descricao", campoConsulta = "cid_descricao", principal = 2)
