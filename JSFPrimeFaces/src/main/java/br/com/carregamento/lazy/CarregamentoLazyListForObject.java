package br.com.carregamento.lazy;
...
import br.com.project.listener.ContextLoaderListenerProjectUtils;
...
public class CarregamentoLazyListForObject<T> extends LazyDataModel<T> {
	...
	private Controller controller = (Controller) ContextLoaderListenerProjectUtils.getBean(Controller.class);
	...
	public void setTotalRegistroConsulta(int totalRegistroConsulta, String query) {
		this.query = query;
