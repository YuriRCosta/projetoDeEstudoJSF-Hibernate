...
public class HibernateUtil implements Serializable{
	...
	private static SessionFactory buildSessionFactory() {
		...
		try {
			...
			e.printStackTrace();
			throw new ExceptionInInitializerError("Erro ao iniciar conexao SessionFactory");
		}
	...
	public static Connection getConnectionProvider() throws SQLException{
		return (Connection) ((SessionFactoryImplementor) sessionFactory).getConnectionProvider();
	}
	
	/**
	 * 
	 * @return Coonection no InitialContext java:/comp/env/jdbc/datasource
	 * @throws Exception
	 */
